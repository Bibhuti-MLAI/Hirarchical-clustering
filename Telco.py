...
data=pd.read_excel("E:\\360digiTMG assignment\\Data Science\\Hirarchical Clustering\\Telco_customer_churn.xlsx")
data.head()
...
z = linkage(df_norm.iloc[:,1:], method = "complete", metric = "euclidean")
...
h_complete=AgglomerativeClustering(n_clusters=4,linkage='complete',affinity = "euclidean").fit(df_norm.iloc[:,1:]) 
