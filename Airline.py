...
dataset = pd.read_excel("E:\\360digiTMG assignment\\Data Science\\Hirarchical Clustering\\EastWestAirlines.xlsx" , sheet_name ='data')
dataset.head()
...
dataset2.iloc[:, 1:].groupby(dataset.clust).mean()
